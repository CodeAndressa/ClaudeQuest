...
from app.domains.gamification.events import events_router
from app.domains.gamification.leagues import leagues_router
from app.domains.gamification.quests import quests_router
